function [twoNewCubes, newTgtCube] = splitCube(tgtCube, dimID, vertexList, newCubeID1 ...
...
% cube
revCube = oneCube(newCubeID1, cubeCapacity);
...
newCube = oneCube(newCubeID2,cubeCapacity);
...
revCube.setParent(tgtCube.identity);
newCube.setParent(tgtCube.identity);
tgtCube.addChildren(newCubeID1);
tgtCube.addChildren(newCubeID2);
tgtCube.disable();
