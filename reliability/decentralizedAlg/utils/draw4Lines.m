function draw4Lines(figPrefix, xLowerBound, xUpperBound, xInterval, y1, y2, y3, y4)
    f1 = figure;
    x=xLowerBound:1:xUpperBound;
    
    plot(x,y1,'-*k', x, y2, '-ok', x, y3, '-xr', x, y4, '-dr'); %线性，颜色，标记
    ...
    legend("case1-10, m=1", "case1-10, m=5", "case2-10, m=1", "case2-10, m=5");   %右上角标注
    xlabel("rounds");
